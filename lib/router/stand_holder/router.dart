...
import 'package:kermanager/screens/stand_holder/kermesse_stand_details_screen.dart';
...
import 'package:kermanager/screens/stand_holder/kermesse_stand_list_screen.dart';
    ...
    branches: [
      ...
      StatefulShellBranch(
        routes: [
          ...
          GoRoute(
            path: StandHolderRoutes.kermesseStandList,
            pageBuilder: (context, state) {
              final params =
                  GoRouterState.of(context).extra as Map<String, int>;
              return NoTransitionPage(
          ...
          GoRoute(
            path: StandHolderRoutes.kermesseStandDetails,
            pageBuilder: (context, state) {
              final params =
                  GoRouterState.of(context).extra as Map<String, int>;
              return NoTransitionPage(
